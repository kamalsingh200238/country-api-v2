    ...
    >
      ...
      <span
        ...
        className={`${enabled ? "translate-x-9" : "translate-x-0"
          } pointer-events-none relative inline-block h-[34px] w-[34px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {theme === "light" ? <BsFillMoonFill /> : null}
          {theme === "dark" ? <BsSunFill /> : null}
        </div>
      </span>
    </Switch>
  );
